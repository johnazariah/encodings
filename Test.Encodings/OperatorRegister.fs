...
module OperatorRegister =
    ...
    [<Theory>]
    [<InlineData("IIII",     "", "(1.0000)",            "IIII")>]
    [<InlineData("IIII", "IIII", "(1.0000)",            "IIII")>]
    [<InlineData("IIII", "IIIX", "(1.0000)",            "IIIX")>]
    [<InlineData("IIII", "XIII", "(1.0000)",            "XIII")>]
    [<InlineData("XIII", "YIII", "(0.0000 + 1.0000 i)", "ZIII")>]
    [<InlineData("XXII", "YYII", "(-1.0000)",           "ZZII")>]
    [<InlineData("XXIZ", "YYII", "(-1.0000)",           "ZZIZ")>]
    [<InlineData("XXYI", "YYZI", "(0.0000 - 1.0000 i)", "ZZXI")>]
    [<InlineData("XXYZ", "YYZX", "(1.0000)",            "ZZXY")>]
