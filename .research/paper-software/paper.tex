...
xUnit + FsCheck test suite (309 passing tests), including both
property-based algebraic checks and targeted edge-case regressions.
Current coverage is 80.02\% line and 67.43\% branch on the core library.
...
cross-encoding consistency checks.  At submission time, 309 tests pass
for the software package, with 80.02\% line coverage and 67.43\% branch
