...
\subsection*{Data Structures and Algebra}

The library includes: a persistent \texttt{FenwickTree<'a>}
(parameterised over any monoid); immutable \texttt{PauliRegister} and
\texttt{PauliRegisterSequence} types with exact symbolic multiplication
(including phase tracking); and a \texttt{Hamiltonian} module for
