...
includes a persistent Fenwick tree ADT, and is validated by 303 unit and
property-based tests.  A complete H$_2$/STO-3G example is provided and
reproduced across all five built-in encodings.
