...
FockMap runs on .NET 10 (GA), Microsoft's open-source, cross-platform runtime. This guide covers installation on Windows, macOS, and Linux, plus container-based workflows.

## About the Platform

### .NET 10

.NET 10 is Microsoft's current General Availability (GA) release of the unified .NET platform. Key characteristics:
