...
FockMap runs on .NET 8, Microsoft's open-source, cross-platform runtime. This guide covers installation on Windows, macOS, and Linux, plus container-based workflows.
